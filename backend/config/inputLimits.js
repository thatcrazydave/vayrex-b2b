module.exports = {
  ...
  auth: {
    username: {
      ...
      description: 'Username must be 3-30 characters (letters, numbers, dots, underscores, hyphens). Must start and end with alphanumeric'
    },
    email: {
      minLength: 5,
      max: 100,
    ...
    fullname: {
      ...
      description: 'Full name must be 2-100 characters (letters including accents, spaces, hyphens, apostrophes, dots, commas)'
    }
  },
  ...
  file: {
    ...
    maxSizeMB: 50,
    allowedExtensions: ['.pdf', '.docx', '.pptx', '.ppt', '.txt', '.png', '.jpg', '.jpeg', '.webp', '.heic', '.heif'],
    allowedMimeTypes: [
      'application/pdf',
